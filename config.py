...
def load_args():
  ...
  parser.add_argument(
        ...
        type=str,
        required=True,
        help='path to pin_dataset root (e.g. .../pin_dataset)'
    )
  parser.add_argument(
      "--data_root5",
      type=str,
      default=None,
      help="5-digit dataset root directory"
  )
  ...
  parser.add_argument(
        ...
        type=str,
        default='checkpoints',
        help='where to save/load model checkpoints'
    )
 # 여기서 batch_size, num_workers, epochs 등 추가
  parser.add_argument(
        '--batch_size',
        type=int,
        default=8,
